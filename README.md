...
En computadora, **Ctrl + rueda sobre el PDF** cambia solamente el zoom del documento (50–300%); la barra conserva su tamaño. Al abrir un libro se muestra primero la página elegida y luego se **precargan todas las páginas** en el almacenamiento del navegador, con dos tareas simultáneas y prioridad para la lectura. Cada tarea descarga el PDF de una página y prepara su vista previa JPEG. El indicador permite pausar o reanudar y solo anuncia «Libro completo preparado» cuando todas las páginas tienen sus datos guardados y su imagen preparada para mostrarse. Se mantienen unas pocas páginas PDF dibujadas a alta resolución en RAM.
...
Al avanzar, retroceder o saltar a una página preparada, se muestra su imagen con las dimensiones reales mientras se recuperan el texto seleccionable y el dibujo de alta resolución, sin sustituirla por un recuadro vacío. Las vistas previas (hasta 640 × 880 píxeles) y sus dimensiones se guardan también en disco para reutilizarlas al volver a abrir el libro. La primera preparación completa depende del tamaño y la complejidad del libro y del dispositivo; antes de que termine todavía puede haber páginas pendientes.
