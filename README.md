...
Durante la lectura, cada página visitada conserva una imagen comprimida ya preparada. Al regresar se muestra esa imagen con las mismas dimensiones mientras se recuperan el texto seleccionable y el dibujo de alta resolución, sin sustituirla por un recuadro vacío. Estas imágenes se conservan durante la sesión del visor; las páginas PDF precargadas se guardan en disco entre sesiones.
